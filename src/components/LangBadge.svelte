<script lang="ts">
  ...
  const badgeConfigs: BadgeConfigs = {
    ...
    postman: { name: 'Postman', color: '8BC0D0', icon: 'postman' },
    readyapi: { name: 'ReadyAPI', color: '4EAA25', icon: 'readyapi' },
    qemu: { name: 'QEMU', color: '4EAA25', icon: 'qemu' },
    virtualbox: { name: 'VirtualBox', color: '3DDC84', icon: 'virtualbox' },
